...
`abstract class ASSTask : `[`PropertyTask`](../-property-task/index.md) [(source)](https://github.com/Myaamori/SubKt/blob/0.1.19/src/main/kotlin/myaa/subkt/tasks/asstasks.kt#L23)
...
| [removeComments](remove-comments.md) | `val removeComments: `[`Property`](https://docs.gradle.org/current/javadoc/org/gradle/api/provider/Property.html)`<`[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)`!>!`<br>Whether to remove comments from the output file. |
...
| Name | Summary |
|---|---|
| [ASS](../-a-s-s/index.md) | `open class ASS : `[`ASSTask`](./index.md)<br>Generic task for modifying ASS files. See [ASSFile](../../myaa.subkt.ass/-a-s-s-file/index.md) and related classes for more information. The modified file is written to a new file. |
