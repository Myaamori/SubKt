...
Download the [project template](https://github.com/Myaamori/SubKt/releases/download/0.1.8/subkt-template-0.1.8.zip) and place the files in the directory where you keep your project files.
