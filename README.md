...
Download the [project template](https://github.com/Myaamori/SubKt/releases/download/0.1/subkt-template-0.1.zip) and place the files in the directory where you keep your project files.
